...
describe('main', () => {
  ...
  describe('init function', () => {
    it('should initialize widget successfully with valid container', () => {
      ...
      expect(console.info).toHaveBeenCalledWith('SequraWidget initialized!', props);
    });
    ...
    it('should handle missing container gracefully', () => {
      ...
      expect(console.error).toHaveBeenCalledWith('SequraWidget: container not found');
    ...
    it('should handle React root creation errors', () => {
      ...
      expect(console.error).toHaveBeenCalledWith('SequraWidget: Initialization failed', error);
    });
    ...
    it('should handle render errors gracefully', () => {
      ...
      expect(console.error).toHaveBeenCalledWith('SequraWidget: Render error', renderError);
    });
